...
public class DDSParser implements DDSParserConstants {
    ...
    /**
     * Add the variable pointed to by CURRENT to either the topmost ctor object
     * on the stack CTOR or to the dataset variable table TABLE if CTOR is
     * empty. If it exists, the current ctor object is poped off the stack and
     * assigned to CURRENT.
     * 
     ...
     * 
     * @param keyword
     *            The lower case to test against.
     * @param word
     *            Does this match keyword? (Case folded to lower.)
     */
    private boolean isKeyword(String word, String keyword) {
        return keyword.equalsIgnoreCase(word);
    }

    final public void Dataset(DDS dds, BaseTypeFactory factory)
    ...
    // the previously reserved words Byte, Int16, et cetera. This allows
    // datasets
    ...
    final private int[] jj_la1_0 = { 0x40, 0xfff80, 0xfff80, 0xfff00, 0xff800,
            0x2000000, 0x2000000, 0x2000000, 0x2000000, 0x2000000, 0x2000000,
            0x2000000, 0x2000000, 0x2000000, 0x2000000, 0x2000000, 0x2000000,
            0x2000000, 0x2000000, 0x1fff80, 0x2000000, 0x1fff80, };
