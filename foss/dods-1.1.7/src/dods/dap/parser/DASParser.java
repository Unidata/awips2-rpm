...
public class DASParser implements DASParserConstants {
    ...
    final public void Strs() throws ParseException, DASException {
        ...
        try {
            ...
            // we have an unterminated double quote on our hands). 5/29/2002
            // jhrg
    ...
    void addAttribute(int type, String name, String value)
            throws ParseException, DASException {
        try {
            if (isStackEmpty()) {
            ...
            // appendAttribute throws a variety of DASExceptions if the
            // attribute
            // tuple is bad. This includes throwing AttribtueBadValueException
            // if
    ...
    void addBadAttribute(String container_name, int type, String name,
            String value, String msg) throws ParseException, DASException {
        String errorContainerName = container_name + "_dods_errors";

        // First, if this bad value is already in a *_dods_errors container,
        // then just add it. This can happen when the server side processes a
        // DAS
        // and then hands it off to a client which does the same. The false
        // value
        ...
        // Otherwise, make a new container. Call it <attr's name>_errors. If
        // that
        ...
        // string to an attribute in the container called `<name_explanation.'.
            ...
            if (a != null)
                ...
                errorContainer = topOfStack().appendContainer(
                        errorContainerName);
    ...
    final private int[] jj_la1_0 = { 0x40, 0x40, 0x3ffc0, 0x200000, 0x200000,
            0x200000, 0x200000, 0x200000, 0x200000, 0x200000, 0x200000,
            0x200000, 0x60000, 0x3ffc0, };
