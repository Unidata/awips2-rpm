...
/**
 * The DataDDS class extends DDS to add new methods for retrieving data from the
 * server, and printing out the contents of the data.
 * 
...
public class DataDDS extends DDS {
    ...
    /**
     * Read the data stream from the given InputStream. In the C++ version, this
     * code was in Connect.
     * 
     * @param is
     ...
     * @exception DataReadException
     *                when invalid data is read, or if the user cancels the
     *                download.
     * @exception DODSException
     *                if the DODS server returned an error.
     */
    public void readData(InputStream is, StatusUI statusUI) throws IOException,
            EOFException, DODSException {
    ...
    /**
     * Dump the dataset using externalize methods. This should create a
     * multipart Mime document with the binary representation of the DDS that is
     * currently in memory.
     * 
     * @param os
     *            the <code>OutputStream</code> to use.
     * @param compress
     *            <code>true</code> if we should compress the output.
     * @param headers
     *            <code>true</code> if we should print HTTP headers.
     * @exception IOException
     *                thrown on any <code>OutputStream</code> exception.
     */
    public final void externalize(OutputStream os, boolean compress,
