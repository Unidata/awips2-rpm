...
FOSSDIR=${WORKSPACE}/foss/qpid-lib/

cp -v ${FOSSDIR}/qpid-client-${VERSION}-bin.tar.gz ${AWIPSII_TOP_DIR}/SOURCES
cp -v ${FOSSDIR}/qpid-cpp-${VERSION}.tar.gz ${AWIPSII_TOP_DIR}/SOURCES
