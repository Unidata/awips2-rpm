...
#
# AWIPS II Python geojson Spec File
#

Name: awips2-python-geojson
Summary: AWIPS II Python geojson module
Epoch: 1
Version: 3.0.1
...
%description
AWIPS II Python geojson Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/geojson-%{version}/packaged"
PACKAGE_FILE="geojson-%{version}-py2.py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/geojson
/awips2/python/lib/python%{_installed_python_short}/site-packages/geojson-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/geojson/__pycache__


%changelog
* Tue May 30 2023 Tom Gurney <thomas.gurney@rtx.com>
- Upgrade to 3.0.1 to support Python 3.11
