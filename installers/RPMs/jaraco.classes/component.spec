...
#
# AWIPS II Python jaraco.classes Spec File
#

Name: awips2-python-jaraco.classes
Summary: AWIPS II Python jaraco.classes Distribution
Epoch: 1
Version: 3.2.1
...
%description
AWIPS II Python jaraco.classes Site-Package
...
%install
pushd . > /dev/null
src_dir="%{_baseline_workspace}/foss/jaraco.classes-%{version}/packaged"
package_file="jaraco.classes-%{version}-py3-none-any.whl"
