...
#
# AWIPS II Python cppy Spec File
#

Name: awips2-python-cppy
Summary: AWIPS II Python cppy Distribution
Version: 1.2.1
...
%description
AWIPS II Python cppy Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/cppy-%{version}/packaged"
PACKAGE_FILE="cppy-%{version}-py3-none-any.whl"
