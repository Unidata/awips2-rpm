...
#
# AWIPS II Python PBR Spec File
#

Name: awips2-python-pbr
Summary: AWIPS II Python PBR Distribution
Version: 5.2.0
...
Provides: awips2-python-pbr = %{version}

BuildRequires: awips2-python
BuildRequires: awips2-python-setuptools

%description
AWIPS II Python PBR Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/pbr-%{version}/packaged"

cp -rv ${SRC_DIR}/pbr-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf pbr-%{version}.tar.gz
cd pbr-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/pbr-%{version}
