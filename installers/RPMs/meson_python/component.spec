...
Name: awips2-python-meson_python
Summary: AWIPS II Python meson_python module
Version: 0.13.1
...
Requires: awips2-meson
Requires: awips2-python-pyproject_metadata

BuildRequires: awips2-python
BuildRequires: awips2-python-setuptools

%description
AWIPS II Python meson_python Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/meson_python-%{version}/packaged"
PACKAGE_FILE="meson_python-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/mesonpy
/awips2/python/lib/python%{_installed_python_short}/site-packages/meson_python-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/mesonpy/__pycache__


%changelog
* Wed Jun 07 2023 David Gillingham <david.gillingham@rtx.com> 
