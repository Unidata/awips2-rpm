...
Name: awips2-python-pyproject_metadata
Summary: AWIPS II Python pyproject_metadata module
Version: 0.7.1
...
%description
AWIPS II Python pyproject_metadata Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/pyproject_metadata-%{version}/packaged"
PACKAGE_FILE="pyproject_metadata-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/pyproject_metadata
/awips2/python/lib/python%{_installed_python_short}/site-packages/pyproject_metadata-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/pyproject_metadata/__pycache__
