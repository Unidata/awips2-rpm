...
%build
SRC_DIR="%{_baseline_workspace}/foss/werkzeug-%{version}/packaged"

cp -rv ${SRC_DIR}/werkzeug-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf werkzeug-%{version}.tar.gz
cd werkzeug-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/werkzeug-%{version}
