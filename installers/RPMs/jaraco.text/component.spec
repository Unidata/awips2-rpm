...
#
# AWIPS II Python jaraco.text Spec File
#

Name: awips2-python-jaraco.text
Summary: AWIPS II Python jaraco.text Distribution
Epoch: 1
Version: 3.5.0
...
Requires: awips2-python-importlib-resources
Requires: awips2-python-jaraco.functools

BuildRequires: awips2-python

%description
AWIPS II Python jaraco.text Site-Package
...
%install
pushd . > /dev/null
src_dir="%{_baseline_workspace}/foss/jaraco.text-%{version}/packaged"
package_file="jaraco.text-%{version}-py3-none-any.whl"
