...
FOSSDIR=${WORKSPACE}/foss/qpid-lib-0.32/

cp -v ${FOSSDIR}/qpid-client-0.32-bin.tar.gz ${AWIPSII_TOP_DIR}/SOURCES
cp -v ${FOSSDIR}/qpid-cpp-0.32.tar.gz ${AWIPSII_TOP_DIR}/SOURCES
