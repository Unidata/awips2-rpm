...
%define _postgresql_version 9.3.9
...
cp -r %{_postgres_src_loc}/scripts/start_postgres.sh ${RPM_BUILD_ROOT}/awips2/postgresql/bin
...
PROFILE_D_DIR="%{_postgres_src_loc}/scripts/profile.d"
cp ${PROFILE_D_DIR}/* %{_build_root}/etc/profile.d 

# Include the postgresql service script
cp %{_postgres_src_loc}/scripts/init.d/edex_postgres \
