...
%define _installed_python %(if [ -f /awips2/python/bin/python ]; then /awips2/python/bin/python -c 'import sys; print(".".join(map(str, sys.version_info[:2])))'; else echo 0; fi)
%define _installed_python_short %(if [ -f /awips2/python/bin/python ]; then /awips2/python/bin/python -c 'import sys; print(".".join(map(str, sys.version_info[:2])))'; else echo 0; fi)

#
# AWIPS II Python six Spec File
#
...
Provides: awips2-python-six = %{version}

BuildRequires: awips2-python

%description
AWIPS II Python six Site-Package
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/six-%{version}
