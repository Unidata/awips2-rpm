...
BuildRequires: awips2-python, expat-devel, gcc-c++, make
...
cp -v %{FOSS_DIR}/apr-%{APR_VERSION}/packaged/apr-%{APR_VERSION}.tar.gz .
cp -v %{FOSS_DIR}/apr-util-%{APR_UTIL_VERSION}/packaged/apr-util-%{APR_UTIL_VERSION}.tar.gz .
...
export CPPFLAGS="-I/awips2/python/include/python3.6m"
...
/sbin/chkconfig httpd-pypies on --level 35
...
if [ $hasRamdrive == 0 ]; then
    echo "tmpfs       /awips2/hdf5_locks/ tmpfs   nodev,nosuid,noexec,size=10M    0 0" >> /etc/fstab
fi
...
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/
...
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/ABOUT_APACHE
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/CHANGES
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/LICENSE
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/NOTICE
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/README
/awips2/httpd_pypies/usr/share/doc/awips2-httpd-pypies-%{version}/VERSIONING
