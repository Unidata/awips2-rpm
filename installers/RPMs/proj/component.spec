...
Name: awips2-python-proj
Summary: AWIPS II PROJ Site-Package
Epoch: 1
Version: 8.2.1
...
Requires: awips2-python-sqlite3
BuildRequires: awips2-python
BuildRequires: awips2-python-sqlite3

%description
AWIPS II PROJ Site-Package
...
proj_src="proj-%{version}"
proj_src_dir="%{_baseline_workspace}/foss/${proj_src}/packaged"

cp "${proj_src_dir}/${proj_src}.tar.gz" %{_python_build_loc} || exit 1
