...
install -pm 755 %{version}/bin/* %{buildroot}/awips2/qpid/bin

mkdir -p %{buildroot}/awips2/qpid/etc
install -pm 755 %{version}/etc/* %{buildroot}/awips2/qpid/etc

mkdir -p %{buildroot}/awips2/qpid/lib
install -pm 755 %{version}/lib/*.jar %{buildroot}/awips2/qpid/lib
install -pm 755 %{version}/lib/*.zip %{buildroot}/awips2/qpid/lib
