...
#
# AWIPS II Python funcsigs Spec File
#

Name: awips2-python-funcsigs
Summary: AWIPS II Python funcsigs Distribution
Version: 1.0.2
...
Provides: awips2-python-funcsigs = %{version}

BuildRequires: awips2-python
BuildRequires: awips2-python-setuptools

%description
AWIPS II Python funcsigs Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/funcsigs-%{version}/packaged"

cp -rv ${SRC_DIR}/funcsigs-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf funcsigs-%{version}.tar.gz
cd funcsigs-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/funcsigs-%{version}
