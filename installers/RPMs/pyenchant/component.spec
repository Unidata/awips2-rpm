...
#
# AWIPS II Python enchant Spec File
#

Name: awips2-python-pyenchant
Summary: AWIPS II Python pyenchant module
Epoch: 1
Version: 3.2.2
...
%description
AWIPS II Python pyenchant Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/pyenchant-%{version}/packaged"
PACKAGE_FILE="pyenchant-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/enchant
/awips2/python/lib/python%{_installed_python_short}/site-packages/pyenchant-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/enchant/__pycache__


%changelog
* Tue Jun 06 2023 John Sebahar <john.sebahar@raytheon.com>
- Upgrade pyenchant to version 3.2.2.
