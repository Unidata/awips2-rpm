...
#
# AWIPS II Python netcdf4-python Spec File
#
...
Obsoletes: awips2-python-pupynere
Obsoletes: awips2-python-scientific

%description
AWIPS II Python netcdf4-python Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/python-netcdf4-%{version}/packaged"

cp -rv ${SRC_DIR}/netCDF4-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf netCDF4-%{version}.tar.gz
cd netCDF4-%{version}

export HDF5_DIR="/awips2/hdf5/"
export NETCDF4_DIR="/awips2/netcdf/"
...
export HDF5_DIR="/awips2/hdf5/"
export NETCDF4_DIR="/awips2/netcdf/"
cd %{_python_build_loc}/netCDF4-%{version}
