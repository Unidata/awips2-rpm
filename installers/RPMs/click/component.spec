...
#
# AWIPS II Python click Spec File
#

Name: awips2-python-click
Summary: AWIPS II Python click module
Epoch: 1
Version: 8.0.1
...
%description
AWIPS II Python click Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/click-%{version}/packaged"
PACKAGE_FILE="click-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/click
/awips2/python/lib/python%{_installed_python_short}/site-packages/click-%{version}.dist-info
