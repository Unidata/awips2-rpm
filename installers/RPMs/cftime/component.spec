...
#
# AWIPS II Python cftime Spec File
#

Name: awips2-python-cftime
Summary: AWIPS II Python cftime Distribution
Version: 1.0.3.4
...
Provides: awips2-python-cftime = %{version}
...
%description
AWIPS II Python cftime Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/cftime-%{version}/packaged"

cp -rv ${SRC_DIR}/cftime-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf cftime-%{version}.tar.gz
cd cftime-%{version}
