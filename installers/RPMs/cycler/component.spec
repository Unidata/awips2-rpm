...
Provides: awips2-python-cycler = %{version}
...
%build
SRC_DIR="%{_baseline_workspace}/foss/cycler-%{version}/packaged"

cp -rv ${SRC_DIR}/cycler-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf cycler-%{version}.tar.gz
cd cycler-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/cycler-%{version}
