...
%description
AWIPS II Python fontTools Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/fonttools-%{version}/packaged"
PACKAGE_FILE="fonttools-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/fontTools
/awips2/python/lib/python%{_installed_python_short}/site-packages/fonttools-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/fontTools/__pycache__
