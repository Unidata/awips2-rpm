...
%define _src_pkg_prefix certifi

#
# AWIPS II Python certifi Spec File
#
...
%description
AWIPS II Python certifi Site-Package
...
PACKAGE_FILE="%{_src_pkg_prefix}-%{version}-py3-none-any.whl"
