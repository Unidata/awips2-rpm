...
%description
AWIPS II Python Distribution - Contains Python V2.7.9 plus modules
...
%build
PYTHON_TAR="Python-2.7.9.tgz"
PYTHON_PROJECT_SRC_DIR="%{_baseline_workspace}/foss/python-2.7.9/packaged/"
FOSS_PYTHON_DIR="%{_baseline_workspace}/foss/python-2.7.9/packaged/"
...
rm -f Python-2.7.9/Lib/test/bad_coding3.py
RC=$?
if [ ${RC} -ne 0 ]; then
   exit 1
fi
...
cd %{_python_build_loc}/Python-2.7.9
