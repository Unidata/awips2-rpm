...
Name: awips2-meson
Summary: AWIPS II Meson Distribution
Version: 1.0.2
...
%build
SRC_DIR="%{_baseline_workspace}/foss/meson-%{version}/packaged"
SRC_PACKAGE="meson-%{version}.tar.gz"
...
cd meson-%{version} || exit 1
/awips2/python/bin/python setup.py build || exit 1
popd > /dev/null

%install
pushd . > /dev/null
cd %{_python_build_loc}/meson-%{version} || exit 1
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/mesonbuild/*
/awips2/python/lib/python%{_installed_python_short}/site-packages/meson-%{version}-py%{_installed_python_short}.egg-info/*
