...
#
# AWIPS II Python portend Spec File
#

Name: awips2-python-portend
Summary: AWIPS II Python portend Distribution
Version: 2.4
...
Requires: awips2-python-tempora
Provides: awips2-python-portend = %{version}
...
%description
AWIPS II Python portend Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/portend-%{version}/packaged"

cp -rv ${SRC_DIR}/portend-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf portend-%{version}.tar.gz
cd portend-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/portend-%{version}
