...
#
# AWIPS II Python QtAwesome Spec File
#

Name: awips2-python-qtawesome
Summary: AWIPS II Python QtAwesome module
Epoch: 1
Version: 1.0.2
...
Requires: awips2-python-qtpy

BuildRequires: awips2-python


%description
AWIPS II Python QtAwesome Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/QtAwesome-%{version}/packaged"
PACKAGE_FILE="QtAwesome-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/qtawesome
/awips2/python/lib/python%{_installed_python_short}/site-packages/QtAwesome-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/qtawesome/__pycache__
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/qtawesome/*/__pycache__
%defattr(755,awips,fxalpha,755)
/awips2/python/bin/qta-browser
