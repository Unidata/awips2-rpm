...
#
# AWIPS II Python natsort Spec File
#

Name: awips2-python-natsort
Summary: AWIPS II Python natsort module
Epoch: 1
Version: 8.3.1
...
%description
AWIPS II Python natsort Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/natsort-%{version}/packaged"
PACKAGE_FILE="natsort-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/natsort
/awips2/python/lib/python%{_installed_python_short}/site-packages/natsort-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/natsort/__pycache__

%defattr(755,awips,fxalpha,755)
/awips2/python/bin/natsort
