...
#
# AWIPS II Python mercantile Spec File
#

Name: awips2-python-mercantile
Summary: AWIPS II Python mercantile module
Epoch: 1
Version: 1.0.0
...
Requires: awips2-python-click >= 3.0

BuildRequires: awips2-python
BuildRequires: awips2-python-setuptools

%description
AWIPS II Python mercantile Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/mercantile-%{version}/packaged"
PACKAGE_FILE="mercantile-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/mercantile
/awips2/python/lib/python%{_installed_python_short}/site-packages/mercantile-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/mercantile/__pycache__

%defattr(755,awips,fxalpha,755)
/awips2/python/bin/mercantile
