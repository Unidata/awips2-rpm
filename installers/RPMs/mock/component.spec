...
#
# AWIPS II Python mock Spec File
#

Name: awips2-python-mock
Summary: AWIPS II Python mock Distribution
Version: 2.0.0
...
Requires: awips2-python-funcsigs
Requires: awips2-python-pbr
Requires: awips2-python-six
Provides: awips2-python-mock = %{version}

BuildRequires: awips2-python
BuildRequires: awips2-python-setuptools
BuildRequires: awips2-python-pbr

%description
AWIPS II Python mock Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/mock-%{version}/packaged"

cp -rv ${SRC_DIR}/mock-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf mock-%{version}.tar.gz
cd mock-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/mock-%{version}
