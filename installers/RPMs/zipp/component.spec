...
#
# AWIPS II Python zipp Spec File
#
...
%description
AWIPS II Python zipp Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/zipp-%{version}/packaged"
PACKAGE_FILE="zipp-%{version}-py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/zipp
/awips2/python/lib/python%{_installed_python_short}/site-packages/zipp-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/zipp/__pycache__
