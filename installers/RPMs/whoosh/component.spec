...
#
# AWIPS II Python Whoosh Spec File
#

Name: awips2-python-whoosh
Summary: AWIPS II Python Whoosh module
Epoch: 1
Version: 2.7.4
...
%description
AWIPS II Python Whoosh Site-Package
...
%install
pushd . > /dev/null
SRC_DIR="%{_baseline_workspace}/foss/whoosh-%{version}/packaged"
PACKAGE_FILE="Whoosh-%{version}-py2.py3-none-any.whl"
...
/awips2/python/lib/python%{_installed_python_short}/site-packages/whoosh
/awips2/python/lib/python%{_installed_python_short}/site-packages/Whoosh-%{version}.dist-info
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/whoosh/__pycache__
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/whoosh/*/__pycache__
%exclude /awips2/python/lib/python%{_installed_python_short}/site-packages/whoosh/*/*/__pycache__
