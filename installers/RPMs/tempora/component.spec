...
#
# AWIPS II Python tempora Spec File
#

Name: awips2-python-tempora
Summary: AWIPS II Python tempora Distribution
Version: 1.14.1
...
Requires: awips2-python-jaraco.functools
Provides: awips2-python-tempora = %{version}
...
%description
AWIPS II Python tempora Site-Package
...
%build
SRC_DIR="%{_baseline_workspace}/foss/tempora-%{version}/packaged"

cp -rv ${SRC_DIR}/tempora-%{version}.tar.gz %{_python_build_loc}
pushd . > /dev/null
cd %{_python_build_loc}
tar xf tempora-%{version}.tar.gz
cd tempora-%{version}
...
%install
pushd . > /dev/null
cd %{_python_build_loc}/tempora-%{version}
