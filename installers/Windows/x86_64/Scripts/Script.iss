...
[Icons]
; Icons for CAVE
Name: {commondesktop}\AWIPS II CAVE; Filename: {app}\Cave\cave.exe; Parameters: "-component thinclient -vm ""{code:GetJavaJDKDir}\bin\javaw.exe"""; Tasks: desktopicon; WorkingDir: {app}\Cave; Comment: "AWIPS II CAVE"; Components: cave; IconFilename: {app}\CAVE\cave.exe
Name: {group}\AWIPS II CAVE; Filename: {app}\Cave\cave.exe; Parameters: "-component thinclient -vm ""{code:GetJavaJDKDir}\bin\javaw.exe"""; WorkingDir: {app}\Cave; Comment: "AWIPS II CAVE"; Components: cave; IconFilename: {app}\CAVE\cave.exe
...
Root: HKLM64; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: expandsz; ValueName: "Path"; ValueData: "{code:GetJavaJDKDir}\bin;{olddata}"; Check: AddToPath(ExpandConstant('{code:GetJavaJDKDir}\bin'))
